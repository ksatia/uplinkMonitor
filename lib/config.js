...
// environments[passedEnvironment] would check the value of passedEnvironment as a standalone variable before trying to access
// ^ use bracket notation here because we CAN'T USE VARIABLES WITH DOT NOTATION - it'll just try to look up a property
